...
/**
 * Created by yanxin on 2018-3-12.
 */
...
//                mHandler.postDelayed(mLongClickRunnable, dragResponseMS);
                ...
                Log.e("DragGridView","mUpScrollBorder= "+mUpScrollBorder);
...
//                mDragBitmap = mStartDragItemView.getDrawingCache();
    ...
    private Runnable mScrollRunnable = new Runnable() {
        ...
        public void run() {
            ...
            Log.e("DragGridView","scrollY= "+scrollY);
        }
    };
